...
function RegisterAdmin() {
    ...
    function register() {
        ...
        axios.post(`${import.meta.env.VITE_SERVER_URL}register_admin`,
            {
    ...
    return <div className="full-height light-pink pb-5">
        ...
        <div className="card mx-4 px-4">
            ...
            <input className="form-control mt-3" placeholder="Secret pantry key" type='password' onChange={(e) => setPantryKey(e.target.value)}></input>
